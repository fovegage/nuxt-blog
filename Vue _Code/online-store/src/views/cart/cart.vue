      ...
      <div class="goods-list">
        <ul>
          <li class="cle hover" style="border-bottom-style: none;" v-for="(item,index) in goods.goods_list">
            ...
            <div class="price-xj">
              <p><em>￥{{item.goods.sold_price}}元</em></p>
            </div>
            ...
            <div class="price-xj"><span></span>
              <em id="total_items_3137">￥{{item.goods.sold_price * item.nums}}元</em>
            </div>
            <div class="del">
    ...
    created () {
      ...
      getShopCarts().then((response)=> {
        ...
        response.data.forEach(function(entry) {
          totalPrice += entry.goods.sold_price*entry.nums
          console.log(entry.goods.sold_price);
        });
    ...
    methods: {
      ...
      setTotalPrice(){
        ...
        for(var i = 0;i<goods_list.length;i++){
          totalPrice=totalPrice+goods_list[i].nums* goods_list[i].goods.sold_price;
        }
        this.totalPrice = totalPrice;
      },
