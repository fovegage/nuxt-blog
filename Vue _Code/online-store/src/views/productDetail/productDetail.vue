            ...
            <div class="detail_wrap">
                ...
                <div class="item-info" id="item-info">
                    <dl class="loaded">
                        ...
                        <p class="desc"> <span class="gray">{{proDetail.good_desc}}</span> </p>
                        </dt>
                        <dd class="property">
                            <ul>
                                ...
                                <li>
                                    <span class="icon_promo">抢购</span> <span class="lbl">促销价</span><span class="unit"> <strong class="nala_price red" id="ECS_SHOPPRICE">￥{{proDetail.sold_price}}元</strong> </span>  <span class="timedown" id="timedown"></span>
                                </li>
                                <li>
                            ...
                            <ul class="sku">
                                <li class="skunum_li cle">
                                    ...
                                    <div class="skunum" id="skunum">
                                        ...
                                        <cite class="storage">(<font id="shows_number">{{proDetail.good_num}}件</font>)</cite>
                        ...
                        <div class="product_tabs">
                            <div class="sectionbox z-box" id="spxqitem">
                                <div class="spxq_main">
                                    ...
                                    <div class="spxq_dec">
                                        <p v-html="proDetail.good_detail">
                                        </p>
                                    </div>
                                </div>
                            </div>
